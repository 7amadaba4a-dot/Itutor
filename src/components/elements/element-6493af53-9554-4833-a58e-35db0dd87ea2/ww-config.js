...
export default {
        ...
        customSettingsPropertiesOrder: [
            ...
            // Chat data + message mapping
            {
                ...
                properties: [
                    ...
                    'mappingTimestamp',
                    'mappingAttachments',
                    'mappingMessageStatus', // Added message status mapping
                ],
            },
    ...
    properties: {
        ...
        messageStatusDisplay: {
            label: { en: 'Display Status Indicators' },
            type: 'OnOff',
            section: 'style',
            bindable: true,
            classes: true,
        ...
        sentIcon: {
            ...
            responsive: true,
            defaultValue: 'check',
            hidden: content => content.messageStatusDisplay === false,
        },
        sentIconColor: {
            label: { en: 'Sent Icon Color' },
            type: 'Color',
            section: 'style',
            bindable: true,
            classes: true,
        ...
        mappingMessageStatus: {
            ...
            defaultValue: {
                type: 'f',
                code: "context.mapping?.['status'] ?? 'sent'",
            },
            section: 'settings',
            hidden: (content, _, boundProps) => !boundProps.messages,
        },
